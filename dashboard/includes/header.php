    ...
    <div class="z-[9]" id="app_header">
          ...
          <div class="nav-tools flex items-center lg:space-x-5 space-x-3 rtl:space-x-reverse leading-0">    
            ...
            <div class="md:block hidden w-full">
              ...
              inline-flex items-center" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <span
                  class="flex-none text-slate-600 dark:text-white text-sm font-normal items-center lg:flex hidden overflow-hidden text-ellipsis whitespace-nowrap"><?php echo $_SESSION['admin_name']; ?></span>
                <svg
      ...
      overflow-hidden">
                <ul class="py-1 text-sm text-slate-800 dark:text-slate-200">
                  <li>
                    <form method="GET" action="./../home/logout.php">
                      <button type="submit" name="logOutBtn"
                              class="w-full block px-4 py-2
                                     hover:bg-slate-100 dark:hover:bg-slate-600
                                     dark:hover:text-white font-inter text-sm
                                     text-slate-600
